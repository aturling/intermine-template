...
<div align="center" id="headercontainer">
  ...
  <div id="header">
    <a href="${WEB_PROPERTIES['project.sitePrefix']}" alt="Home" rel="NOFOLLOW"><img id="logo" src="model/images/logo.png" width="45px" height="45px" alt="Logo" /></a>
  ...
  <div id="menucontainer">
    <ul id="nav">
      ...
      <li id="Help"  <c:if test="${tab == 'Help'}">class="activelink"</c:if>>
        <a href="<INSERT READTHEDOCS LINK HERE>" target="_blank">
