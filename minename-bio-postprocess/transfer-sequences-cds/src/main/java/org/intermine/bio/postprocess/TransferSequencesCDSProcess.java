 ...
 *
 * Custom version: changed main db query, changed how CDS handled, added transfer for
 * PseudogenicTranscripts and PseudogenicExons.
 *
 * @author Kim Rutherford
 * @author
 */
public class TransferSequencesCDSProcess extends PostProcessor
{
    private Model model;
    private static final Logger LOG = Logger.getLogger(TransferSequencesCDSProcess.class);
     ...
     */
    public TransferSequencesCDSProcess(ObjectStoreWriter osw) {
        super(osw);
    }
