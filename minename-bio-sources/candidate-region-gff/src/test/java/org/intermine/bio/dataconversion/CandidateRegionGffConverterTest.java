...
public class CandidateRegionGffConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    CandidateRegionGffConverter converter;
    MockItemWriter itemWriter;

    public CandidateRegionGffConverterTest(String arg) {
        super(arg);
    }
