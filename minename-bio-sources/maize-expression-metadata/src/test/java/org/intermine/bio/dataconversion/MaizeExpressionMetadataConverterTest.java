...
public class MaizeExpressionMetadataConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    MaizeExpressionMetadataConverter converter;
    MockItemWriter itemWriter;

    public MaizeExpressionMetadataConverterTest(String arg) {
        super(arg);
    }
