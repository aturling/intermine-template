...
public class RefSeqGFF3RecordHandler extends BaseGFF3RecordHandler
{
    ...
    public RefSeqGFF3RecordHandler (Model model) {
        ...
        // relationship: nontranscribed_pseudogenic_exon <-> nontranscribed_pseudogene
        refsAndCollections.put("NontranscribedPseudogenicExon", "gene");        
    ...
    public void process(GFF3Record record) {
        ...
        } else if (clsName.equals("Transcript") || clsName.equals("MRNA") || clsName.equals("PseudogenicTranscript")) {
