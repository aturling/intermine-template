 ...
 * @author
 */
public class BasePathwayConverter extends BioFileConverter
{
    protected static final Logger LOG = Logger.getLogger(BasePathwayConverter.class);
     ...
     */
    public BasePathwayConverter(ItemWriter writer, Model model, String dataSourceName, String dataSetTitle) {
     ...
     */
    public void setPathwayOrganisms(String taxonIds) {
