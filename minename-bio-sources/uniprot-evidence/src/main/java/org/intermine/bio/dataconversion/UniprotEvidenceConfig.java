 ...
 * @author
 */
public class UniprotEvidenceConfig
{
    private static final Logger LOG = Logger.getLogger(UniprotEvidenceConfig.class);
     ...
     */
    public UniprotEvidenceConfig(String propFile) {
        if (propFile != null) {
